...
debugObject.envMapIntensity = 1.25
...
gltfLoader.load(
    ...
    (gltf) => {
        ...
        gui.add(gltf.scene.rotation, 'y').min(-Math.PI).max(Math.PI).step(0.001).name('helmetY')
...
gui.add(light, 'intensity').min(0).max(10).step(0.001).name('light')
